...
int main()
{
    ...
    //Создание окна
    RenderWindow window(VideoMode(1280, 720), "Krestiki noliki", Style::Close);
    ...
    //Загрузка текстуры клетка 10
    Object cell10("Images/empty.png", 230, 375);
    ...
    while (window.isOpen())
    {
        ...
        string h = motion + ".png";
        cell10.texture.loadFromFile("Images/" + h);
        //Отрисовка кнопок
